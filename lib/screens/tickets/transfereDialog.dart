...
class ShowReportDialog extends StatelessWidget {
  ...
  ShowReportDialog({super.key, required this.ticketId, required this.token}) {
    ...
    final confirmationResult = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Voulez-vous reporter cette intervention ?'),
          actions: [
            TextButton(
              onPressed: () {
